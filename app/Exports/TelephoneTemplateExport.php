...
class TelephoneTemplateExport implements WithEvents
{
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // A3: Category
                $sheet->setCellValue('A3', 'Category: Telephone    Business View: All Data');
                ...
                $sampleData = [
                    ['John Doe', 5, 'On', 'Area 10 – Fuel Oil Complex I'],
                    ['Jane Smith', 3, 'Off', 'Area 20 – Lube Oil Complex I'],
                    ['Ahmad Rahman', 7, 'Maintenance', 'Area 30 – Area Tangki BBM'],
                ];
                ...
                $sheet->setCellValue('A' . $statusNoteRow, 'NOTE: Available Status: On, Off, Maintenance');
                $sheet->getStyle('A' . $statusNoteRow)->getFont()->setBold(true);
                
                $picNoteRow = $statusNoteRow + 1;
                $sheet->setCellValue('A' . $picNoteRow, 'NOTE: Name = Person In Charge (PIC) untuk telephone');
                $sheet->getStyle('A' . $picNoteRow)->getFont()->setBold(true)->getColor()->setRGB('0066CC');
            },
        ];
    }
}
