...
class RadioTemplateExport implements WithEvents
{
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // A3: Category
                $sheet->setCellValue('A3', 'Category: Radio HT    Business View: All Data');
                ...
                $sampleData = [
                    ['Motorola GP338', 20, 'On', 'Area 10 – Fuel Oil Complex I'],
                    ['Icom IC-F3161', 15, 'Off', 'Area 20 – Lube Oil Complex I'],
                    ['Kenwood TK-3207', 12, 'Maintenance', 'Area 30 – Area Tangki BBM'],
                ];
