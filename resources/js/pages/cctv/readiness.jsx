...
export default function CCTVReadiness({ cctvs = [], filters, flash }) {
    ...
    const handleUploadConfirm = () => {
        post(route('cctv.import'), {
            onSuccess: () => {
                ...
                router.visit(route('cctv.readiness'), { 
                    method: 'get',
                    preserveState: false,
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                            ...
                                            <div className="mt-4">
                                                <div 
                                                    ...
                                                    onDrop={handleDrop}
                                                    onClick={() => document.getElementById('excel-upload-readiness').click()}
                                                >
                                                    <input
                                                        id="excel-upload-readiness"
                                                        type="file"
                                                        accept=".xlsx,.xls"
