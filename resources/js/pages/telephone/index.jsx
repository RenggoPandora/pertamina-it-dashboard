...
export default function Telephone({ telephones, flash, filters }) {
    ...
    const handleDateFilter = ({ startDate, endDate }) => {
        router.get(route('telephone.index'), {
    ...
    const handleUploadConfirm = () => {
        post(route('telephone.import'), {
            ...
            onSuccess: () => {
                ...
                router.visit(route('telephone.index'), {
                    method: 'get',
                    preserveState: false,
                    preserveScroll: false,
                });
    ...
    const handleDownloadTemplate = () => {
        window.location.href = route('telephone.download-template');
    };
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
                        <div className="relative">
                            <input
                                ...
                                placeholder="Cari berdasarkan nama PIC, status, atau lokasi..."
                    ...
                    <div className="p-6">
                        {phones.filter(phone => {
                            ...
                            return (
                                phone.nama_pic?.toLowerCase().includes(query) ||
                                phone.status?.toLowerCase().includes(query) ||
                                phone.site?.lokasi?.toLowerCase().includes(query)
                            );
                        }).length === 0 ? (
                            <div className="text-center text-gray-500 dark:text-gray-400 py-8">
                                <div className="text-6xl mb-4">📞</div>
                                <p className="text-xl mb-2">
                                    {searchQuery ? 'Tidak ada data yang cocok dengan pencarian' : 'Tidak ada perangkat Telephone ditemukan'}
                                </p>
                                ...
                                <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    ...
                                    <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                        ...
                                        <ul className="text-xs text-blue-800 dark:text-blue-400 space-y-1 list-disc list-inside">
                                            <li>Cell A3: Must contain "Telephone"</li>
                                            ...
                                            <li><strong>Name = Person In Charge (PIC)</strong></li>
                                            <li>Columns: A=Name (PIC), B=Amount, C=Status (On/Off/Maintenance), D=Allocation (Site name)</li>
                                        </ul>
                                    </div>
                                </div>
