...
export default function PCDevice({ pcDevices = [], filters }) {
    ...
    const downloadTemplate = () => {
        window.location.href = route('pcdevice.template');
    };
                                ...
                                <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                            <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">
                                                Upload Excel PC Device
                                            </h3>
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                                    Upload file Excel untuk import data PC Device secara batch.
                                                </p>
                                            </div>
                                        </div>
                                        <button
                                    ...
                                    <div className="mt-4">
                                        <div 
                                            ...
                                            onDrop={handleDrop}
                                            onClick={() => document.getElementById('file-upload-pc').click()}
                                        >
                                            {data.file ? (
                                    ...
                                    <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                        ...
                                        <ul className="text-xs text-blue-800 dark:text-blue-400 space-y-1 list-disc list-inside">
                                            <li>Cell A3: Must contain "PC Device"</li>
                                            <li>Cell A6: End Time format for tanggal_pencatatan</li>
                                            <li>Row 9: Column headers (Name, Type, Amount, Allocation)</li>
                                            <li>Row 10+: Data rows</li>
                                            <li>Columns: A=Name, B=Type (Desktop/Notebook/Printer), C=Amount, D=Allocation (MPS/SM5)</li>
                                        </ul>
                                    </div>
                                </div>
