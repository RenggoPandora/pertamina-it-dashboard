...
export default function EditHpboc({ hpboc, sites }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        nama_perangkat: hpboc.nama_perangkat || '',
        jumlah: hpboc.jumlah || '',
        tanggal_pencatatan: formatDateForInput(hpboc.tanggal_pencatatan) || '',
        status: hpboc.status || '',
        site_id: hpboc.site_id || '',
    });

    const submit = (e) => {
        e.preventDefault();
        put(route('hpboc.update', hpboc.id));
    };

    return (
        <>
            <Head title="Edit HP BOC - Pertamina IT Dashboard" />
            <Layout
                activeMenuItem="HP BOC"
                title="Edit HP BOC"
                subtitle="Mengubah informasi perangkat HP BOC"
            >
                {/* Back Button */}
                <div className="mb-6">
                    <a
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                        <div>
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Edit HP BOC</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Ubah informasi HP BOC sesuai kebutuhan</p>
                        </div>
                    ...
                    <form onSubmit={submit} className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Masukkan jumlah HP BOC"
                                required
                            />
                            {errors.jumlah && (
