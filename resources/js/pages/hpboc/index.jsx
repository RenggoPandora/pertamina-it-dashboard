...
export default function HPBOC({ hpboc, flash, filters }) {
    ...
    const handleUploadConfirm = () => {
        post(route('hpboc.import'), {
            preserveState: false,
            preserveScroll: false,
            onSuccess: () => {
                closeUploadModal();
                // Auto refresh after upload
                router.visit(route('hpboc.index'), {
                    method: 'get',
                    preserveState: false,
                    preserveScroll: false,
                });
    ...
    const handleDownloadTemplate = () => {
        window.location.href = route('hpboc.download-template');
    };
    ...
    const handleDelete = (e) => {
        ...
        router.delete(route('hpboc.destroy', selectedDevice.id), {
            onSuccess: () => {
    ...
    return (
        <>
            ...
            <Layout 
                ...
                title="Manajemen HP BOC"
                subtitle="Kelola dan pantau perangkat HP BOC"
            >
                {/* Flash Message */}
                {flash?.success && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Perangkat</h3>
                        <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
                            {devices.reduce((total, device) => total + parseInt(device.jumlah || 0), 0)}
                        </p>
                        <p className="text-xs text-gray-500">Seluruh perangkat HP BOC</p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Kondisi Baik</h3>
                        <p className="text-3xl font-bold text-green-600 mt-2">
                            {devices.filter(d => d.status === 'baik').reduce((total, device) => total + parseInt(device.jumlah || 0), 0)}
                        </p>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        ...
                        <p className="text-3xl font-bold text-red-600 mt-2">
                            {devices.filter(d => d.status === 'rusak').reduce((total, device) => total + parseInt(device.jumlah || 0), 0)}
                        </p>
                    ...
                    <div className="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
                        <div className="relative">
                            <input
                                ...
                                placeholder="Cari berdasarkan nama perangkat, status, atau lokasi..."
                    ...
                    <div className="p-6">
                        {devices.filter(device => {
                            ...
                            return (
                                ...
                                device.site?.lokasi?.toLowerCase().includes(query)
                            );
                        }).length === 0 ? (
                            <div className="text-center text-gray-500 dark:text-gray-400 py-8">
                                <div className="text-6xl mb-4">📊</div>
                                <p className="text-xl mb-2">
                                    {searchQuery ? 'Tidak ada data yang cocok dengan pencarian' : 'Tidak ada perangkat HP BOC ditemukan'}
                                </p>
                                        ...
                                        {devices.filter(device => {
                                            ...
                                            <tr key={device.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a
                                                        href={route('hpboc.edit', device.id)}
                                ...
                                <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    ...
                                    <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                        ...
                                        <ul className="text-xs text-blue-800 dark:text-blue-400 space-y-1 list-disc list-inside">
                                            <li>Cell A3: Must contain "HPBOC"</li>
                                            ...
                                            <li>Columns: A=Name, B=Amount, C=Status (Baik/Rusak/Maintenance), D=Allocation (Site name)</li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg z-50 max-w-md w-full p-6">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h2 className="text-lg font-semibold text-gray-900">Hapus HP BOC</h2>
                                    <p className="text-sm text-gray-600 mt-1">
                                        ...
                                        <br />
                                        Lokasi: <span className="font-medium">{selectedDevice.site?.lokasi || 'N/A'}</span>
                                        <br />
