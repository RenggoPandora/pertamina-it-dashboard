...
export default function Radio({ radio, flash, filters }) {
    ...
    const handleDelete = (e) => {
        ...
        if (!selectedRadio?.id) {
            setDeleteError('Invalid radio ID');
            setIsDeleting(false);
            return;
        }

        router.delete(route('radio.destroy', selectedRadio.id), {
            onSuccess: () => {
            ...
            onError: (error) => {
                ...
                const errorMessage = error?.response?.data?.message || 'Failed to delete radio';
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
                        <div className="relative">
                            <input
                                ...
                                placeholder="Cari berdasarkan nama perangkat, frekuensi, status, atau lokasi..."
                    ...
                    <div className="p-6">
                        {radios.filter(radio => {
                            ...
                            return (
                                radio.nama_perangkat?.toLowerCase().includes(query) ||
                                radio.frekuensi?.toLowerCase().includes(query) ||
                                radio.status?.toLowerCase().includes(query) ||
                                radio.site?.lokasi?.toLowerCase().includes(query)
                            );
                        }).length === 0 ? (
                            <div className="text-center text-gray-500 dark:text-gray-400 py-8">
                                <div className="text-6xl mb-4">📻</div>
                                <p className="text-xl mb-2">
                                    {searchQuery ? 'Tidak ada data yang cocok dengan pencarian' : 'Tidak ada perangkat Radio HT ditemukan'}
                                </p>
                                        ...
                                        {radios.filter(radio => {
                                            ...
                                            <tr key={radio.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a
                                                        href={route('radio.edit', radio.id)}
                                                        className="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 mr-3"
                                                    >
                                                        Ubah
                                                    </a>
                                                    <button 
                                                        onClick={() => openDeleteModal(radio)}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg z-50 max-w-md w-full p-6">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h2 className="text-lg font-semibold text-gray-900">Hapus Radio HT</h2>
                                    <p className="text-sm text-gray-600 mt-1">
                                        Apakah Anda yakin ingin menghapus perangkat <strong>{selectedRadio.nama_perangkat}</strong>?
                                        <br />
                                        Jumlah: <span className="font-medium">{selectedRadio.jumlah}</span>
                                        <br />
                                        Lokasi: <span className="font-medium">{selectedRadio.site?.lokasi || 'N/A'}</span>
                                        <br />
